...
training = "/mount/src/Advanced_learning/streamlit_app/Resultas/training.csv"
history = pd.read_csv(training)
data_tl =  "/mount/src/Advanced_learning/streamlit_app/Resultas/data_evaluation1.csv"
data_tl = pd.read_csv(data_tl)
training_tl = "/mount/src/Advanced_learning/streamlit_app/Resultas/training1.csv"
history_tl = pd.read_csv(training_tl)
data_ssl = "/mount/src/Advanced_learning/streamlit_app/Resultas/data_evaluation2.csv"
data_ssl = pd.read_csv(data_ssl)
training_ssl = "/mount/src/Advanced_learning/streamlit_app/Resultas/training2.csv"
...
if page == pages[4]:
    ...
    st.write("## Résultas")
    st.write("##### Évaluation Équilibrée : Analyse des Performances par Macro-Moyenne")
    st.image("/mount/src/Advanced_learning/streamlit_app/Rresultas/result1.png")
    st.write("##### Performances Pondérées en Fonction de la Fréquence des Classes")
    st.image("/mount/src/Advanced_learning/streamlit_app/Resultas/result2.png")
